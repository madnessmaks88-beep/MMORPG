...
export class ProfileScene extends Phaser.Scene {
  ...
  private createHeader(layout: ProfileLayout) {
    const titleY = layout.safeTop + 26;

    this.add.text(layout.centerX, titleY, 'Профиль героя', {
    ...
    this.add.text(layout.centerX, titleY + 38, 'Катакомбы забвения • досье искателя', {
      fontFamily: UI.font.body,
      fontSize: '15px',
